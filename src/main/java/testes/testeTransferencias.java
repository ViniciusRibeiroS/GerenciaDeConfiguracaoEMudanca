 ...
 * 
 * @Test public void testTransferencia() { Cliente c = new Cliente("Vinicius",
 * 800, 1); Cliente c2 = new Cliente("Victor", 800, 2);
 * 
 * try { c.transferencia(c2, 24, 2); } catch (OperacaoCanceladaException e) { //
 ...
 * 1);
 * 
 * try { c.credito(20); } catch (OperacaoCanceladaException e) { // TODO
 ...
 * 
 * try { c.debito(20); } catch (OperacaoCanceladaException e) { // TODO
 * Auto-generated catch block e.printStackTrace(); } assertEquals(780,
 * c.getSaldo()); }
 * 
 * //Credito de valor negativo
 * 
